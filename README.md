...
For page-level starter layouts without Storybook friction, see the static HTML files in [examples](./examples/).
...
=======
>>>>>>> theirs
High-level page templates (app shell, auth, marketing) that compose SDS primitives and compositions into reusable app-scale structures.

### [examples](./examples/)

Plain HTML template mirrors intended for quick review without Storybook.
<<<<<<< ours
=======
High-level page templates (app shell, auth, and marketing starters) that demonstrate opinionated assembly patterns above compositions.
>>>>>>> theirs
=======
High-level page templates (app shell, auth, and marketing starters) that demonstrate opinionated assembly patterns above compositions.
>>>>>>> theirs
